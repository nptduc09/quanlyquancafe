...
<html lang="en">
  ...
  <body>
    ...
    <div class="bill">
        ...
        <h1>Welcome !</h1><br>
        <p>Bạn hoặc ai đó đang thực hiện việc lấy lại mật khẩu tại website của chúng tôi. Để kích hoạt tài khoản vui lòng click bào liên kết dưới đây</p>
        <button type="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>Kích hoạt tài khoản</button>
        <p>Trường hợp đường dẫn không hoạt động bạn vui lòng copy đường dẫn dưới đây và dán vào trình duyệt</p>
        <a href="{{$link}}"></a>
        <p>xin cảm ơn</p>
                 ...
                 <tr style="border-collapse:collapse">
                  <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                   <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:4px;background-color:#ffffff" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation">
                     ...
                     <tr style="border-collapse:collapse">
                      <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">Nếu bạn có bất kỳ câu hỏi nào khác, vui lòng gửi vào địa chỉ mail: duc09092001@gmail.com<br>Đây là email tự động, vui lòng không phản hồi email này.</p></td>
                     </tr>
                     <tr style="border-collapse:collapse">
