                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(value, key) in list_hd">
                                ...
                                <td class="align-middle">@{{ value.tong_tien_sau_giam_gia }}</td>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Tiền Chiếc Khấu</th>
                        ...
                        <tbody>
                            <tr v-for="(value, key) in lits_ct">
                                ...
                                <td class="text-center align-middle">@{{ value.tien_chiet_khau }}</td>
                                <td class="text-center align-middle">@{{ value.thanh_tien }}</td>
                            </tr>
