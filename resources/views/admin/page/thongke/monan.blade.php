                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(value, key) in lits_ct">
                                ...
                                <td class="align-middle text-center">@{{ value.gia_ban }}</td> <!-- Thêm cột gia_ban -->
                                <td class="align-middle text-center">@{{ value.tien_chiet_khau }}</td> <!-- Thêm cột tien_chiet_khau -->
